<table  class="table table-bordered table-striped" id="dataTable">
    <thead>
        <tr>
            <th>Master Administrator Name</th>
            <th>Username</th>
            <th>Email</th>
            <th>Phone</th>
            <th>Credits</th>
    ...
    <tbody>
        <?php
        if (!empty($masterAdminResult)) {
            foreach ($masterAdminResult as $value) {
                ?>
                <tr>
                    ...
                    <td>
                        <ul  class="list-inline">
                            ...
                            <li><a href="<?= base_url() . 'user/masteradminupdate/' . $value->id; ?>"><i class="fa fa-edit"></i></a></li>
