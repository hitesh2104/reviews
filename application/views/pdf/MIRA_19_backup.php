...
$pdf->Cell(140, 10, $fullName . ' ' .'(' . $testCompletedDate . ')', 0, 0, 'C');
...
// 4rd page
    ...
    $pdf->Ln(5);
    $pdf->SetXY($x + 90, $y + 45);
    $pdf->MultiCell(85, 5, iconv('UTF-8', 'windows-1252', "Leaders on this level are usually leaders of self, having to manage their own work schedules and plan their own day-to-day activities."));

	$pdf->SetFillColor(229, 232, 234);
	$pdf->Rect(115, $y + 70, 80, 70, 'F');
   ...
   $pdf->Ln(5);
    ...
    $pdf->Ln(5);
    $pdf->SetXY($x + 90, $y + 65);
    $pdf->MultiCell(85, 5, iconv('UTF-8', 'windows-1252', 'Leaders on this level tend to lead self as well as moving into an environment where they may be required to manage other technical and/or operational people.'));
    $pdf->SetFillColor(229, 232, 234);
    $pdf->Rect(115, $y + 90, 80, 70, 'F');
    $pdf->SetXY(120, $y + 95);
    $pdf->SetFont('helvetica', 'B', 12);
    $pdf->MultiCell(70, 5, "Time frame (seeing results, impact of decisions):");
    $pdf->Ln(2);
    ...
    $pdf->MultiCell(85, 5, iconv('UTF-8', 'windows-1252', 'In the strategy execution level, they support those working in a level 4 (strategy contextualisation) environment by giving feedback on the impact of the strategic initiatives on their clients and the market they operate in. They also provide forecasts and trends that relates to the business and how the business could potentially improve their product/service offering in the future to address client needs better.'));
     ...
     $pdf->Ln(5);
     $pdf->SetXY($x + 90, $y + 55);
     $pdf->MultiCell(85, 5, iconv('UTF-8', 'windows-1252', 'Leaders on this level are usually leaders of others, at times leader of other first-line managers and/or supervisors.'));
      
      $pdf->SetFillColor(229, 232, 234);
      $pdf->Rect(115, $y + 75, 80, 70, 'F');
    ...
    $pdf->MultiCell(85, 5, iconv('UTF-8', 'windows-1252', 'They work very close with people in the strategy contextualisation (SST 4) environment to gain better understanding of current market conditions and future trends that may impact the business.'));
     ...
     $pdf->Ln(5);
     $pdf->SetXY($x + 90, $y + 30);
        $pdf->MultiCell(85, 5, iconv('UTF-8', 'windows-1252', 'Leaders on this level usually manage numerous business units and at times probably different organisations. They can think across different systems and/or units, being good CEO’s of large organisations.'));
    
      $pdf->SetFillColor(229, 232, 234);
      $pdf->Rect(115, $y + 60, 80, 80, 'F');
