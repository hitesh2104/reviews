...
function funcSpeedOfLearning($val) {
	if ($val >= 0 && $val <= 14) {
		return 1;
...
$total_correct =  @$cresult2["total_correct"];
$average_time =  @$cresult2["average_time"];

$speedOfLearning = funcSpeedOfLearning(@$total_correct);
...
$pdf->MultiCell(90, 5, iconv('UTF-8', 'windows-1252', "It is based on the Stratified Systems Theory (SST) developed by Elliott Jaques that defines work in different organisational levels, mainly on the basis of decision-making complexity. MIRa measures the individual’s capability to find solutions through different levels of complex problems."));
$pdf->Ln(10);
