...
$pdf->Image( $rootPath."images/AST.jpg", -1, 0, 211, 298);
$pdf->SetY(255);
$pdf->SetX(80);
$pdf->SetFont('helvetica', '', 23);
$pdf->SetTextColor(255, 255, 255);
$pdf->Cell(105, 10, "ABC", 0, 1, 'C');
$pdf->SetX(80);
$pdf->SetFont('helvetica', '', 18);
$pdf->Cell(105, 10, '('.date('Y-m-d').')', 0, 0, 'C');
$pdf->SetTextColor(0, 0, 0);
//$pdf->CheckPageBreak(250);
$html =<<< EOF
<br pagebreak="true"/>
<h1>Type Description</h1>
<p class="tips_img">ENFP:  Functional Preference Ordering:</p>
