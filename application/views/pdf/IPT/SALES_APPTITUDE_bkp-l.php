...
if(isset($openTextRes[3]) && !empty($openTextRes[3])){
	...
	$html = "<p style='font-size:12px'>".substr($openTextRes[3], 0, 200)."</p>";
	$pdf->SetY(245);
	$pdf->SetX(0);
	$pdf->SetFont('helvetica', 'N', 12);
