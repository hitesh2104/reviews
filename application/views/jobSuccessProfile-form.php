                                ...
                                <div class="col-md-8 col-lg-6">                 
                                    ...
                                    <div class="form-group">
                                      ...
                                      <?php //$jobTitleArr = array('HR Assistant', 'HR Manager', 'Marketing Consultant', 'IT Technician');
											...
											if(isset($jspData['job_title'])){
												echo '<option value="'.$jspData['job_title'].'" selected="selected" >'.$jspData['job_title'].'</option>';
											}
										?>
                                        </select>
...
function createNewRecord(jobType, val) { 
	if(val==0 && val!=''){
		...
		if (newName != null && newName != '') {
			if($('#'+jobType+' option[value="' + newName + '"]').html() != undefined){
				$('#'+jobType+' option[value="' + newName + '"] ').attr('selected', true);
				//alert('This name already exists. Please cretae new.');
				//createNewRecord(jobType, val);
				return false;
			}
