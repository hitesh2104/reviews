            ...
            <div class="col-xs-12">     
                <div class="box pull-left">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Executive Summary  -->
                        <?php 
							if($isJsp == 1 && (count($test_details)) != $completedTest){
								 echo '<label class="btn btn-primary" >Conclusion</label>'; 
							}else{
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="complete text-center">
                                    ...
                                    <label class="" style="color:#5290f7; cursor: pointer;" <?php echo ($isJsp==1)?((count($test_details)) == $completedTest)?'onclick="excSubmit()"':'':'onclick="excSubmit()"'; ?> >
                                    EXS</label>
                                    <?php } ?>
                                    <br>
                                </div>
                              ...
                              <div class="modal-body">
                                <form action="<?= base_url() ?>candidate/combine_report" target="_blank" id="rfm" method="post">
                                    ...
                                    <?php foreach ($test_details as $value): ?>
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" id="r<?= $value->fk_test_id ?>" value="<?= $value->fk_test_id ?>" class="r_<?= $value->fk_test_id ?>" name="test_list[]" checked id=""><?= "    ".$value->test_name ?>
                                             </label>
                                            <br>
                                            </div>
                                         <?php } ?>
