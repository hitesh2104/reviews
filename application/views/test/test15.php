...
<?php include_once 'include/test15_mira.php';?>
<div class="content-wrapper">
    <section class="content-header">
        <!-- <h2>Matrix of Intellectual Reasoning Assessment Complex(MIRA COM)</h2> -->
    </section>
    <section style="background: #ffffff" class="content">
    <center><h2>Matrices of Intellectual Reasoning Assessment</h2></center>
    <?php if ($sacId == "A") {?>
        <div class="intro1" style="display:block;">
            <h2><u>Introduction</u></h2>
            <br/>
            <p style="font-size:20px; text-align:justify;">
                <p>The Matrices of Intellectual Reasoning assessment (MIRA) measures your ability to think conceptually and to solve problems. This test is divided into three sections:</p>
        ...
        <div id="slider" style="display:none">
            <form method="post" id="questions_form" action="<?=base_url();?>test/processTest15">
                ...
                <ul class="questions_list" id="1">
                    <?php foreach ($sectionOneArr as $key => $secOneArr) {?>
                        <li style="text-align: center; id="slide<?=++$key;?>">
                            <h4><img src="<?=base_url() . 'images/mira_sec_a/' . $secOneArr['img'] . '.png';?>" height="220" width="330"></h4>
                            <br/>
                            <div class="row">
                                <?php foreach ($secOneArr['option'] as $ans => $option) {?>
                                <div class="col-md-3">
                                    <label>
                                    <img src="<?=base_url() . 'images/mira_sec_a/' . $option . '.jpg'?>" height="80"><br>
    ...
    <?php if ($sacId == "B") {?>
        ...
        <div class="introA" style="display:none;">
            ...
            <br />
            <img src="<?=base_url() . 'images/mira_sec_b/sec-b-img.png'?>" height="250" width="100%">
            ...
            <form method="post" id="questions_form" action="<?=base_url();?>test/processTest15">
                ...
                <ul class="questions_list" id="1">
                    <?php foreach ($sectionTwoArr as $key => $secOneArr) {?>
                        <li style="text-align: center; id="slide<?=++$key;?>">
                            <h4><img src="<?=base_url() . 'images/mira_sec_b/' . $secOneArr['img'] . '.jpg';?>" height="220" width="600"></h4>
                            <br/>
                            <div class="row">
                                <?php foreach ($secOneArr['option'] as $ans => $option) {?>
                                ...
                                <div class="col-md-4">
                                <label>
                                    <img src="<?=base_url() . 'images/mirax_sec_b/' . $option . '.jpg'?>" height="150"><br>
                                    <input name="q<?=$key;?>" type="radio" value="<?=$ans;?>"/>
                                </label>
                                </div>
        ...
        <div class="intro3" style="display: none;">
            <div class="row text-center">
                <div class="col-md-4 col-md-offset-4">
                    <img width="182" height="252" src="<?=base_url() . 'images/RAP/example_card.png'?>" id="exmImg" data-idd="3" /><br>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-center">
                    <label>
                        <img width="80" height="80" src="<?=base_url() . 'images/RAP/block/box_A.png'?>" alt="" class="img img-responsive">
                ...
                <div class="col-md-2 text-center">
                    <label>
                        <img width="80" height="80" src="<?=base_url() . 'images/RAP/block/box_B.png'?>" alt="" class="img img-responsive">
                ...
                <div class="col-md-2 text-center">
                    <label>
                        <img width="80" height="80" src="<?=base_url() . 'images/RAP/block/box_C.png'?>" alt="" class="img img-responsive">
                ...
                <div class="col-md-2 text-center">
                    <label>
                        <img width="80" height="80" src="<?=base_url() . 'images/RAP/block/box_D.png'?>" alt="" class="img img-responsive">
                ...
                <div class="col-md-2 text-center">
                    <label>
                        <img width="80" height="80" src="<?=base_url() . 'images/RAP/block/box_E.png'?>" alt="" class="img img-responsive">
        ...
        <div id="slider" style="display:none; height: 550px !important;">
            <center>
                ...
                <form method="post" id="questions_form" action="<?=base_url();?>test/processTest15">
                    ...
                    <ul class="" id="1">
                        <?php shuffle($sectionThreeArr);foreach ($sectionThreeArr as $key => $cards) {?>
                            <li style="text-align: center;" id="slide<?=++$key;?>" data-idd="<?=$cards['ans']?>">
                                <div class="col-md-4 col-md-offset-4">
                                    <img src="<?=base_url() . 'images/RAP2/' . $cards['card']?>"><br>
                                </div>
                            </li>
                        <?php }?>
                    </ul>
                    ...
                    <div class="row mblocks">
                        ...
                        <div class="col-md-2 text-center">
                            <label>
                                <img src="<?=base_url() . 'images/RAP/block/box_A.png'?>" alt="" class="img img-responsive">
                        ...
                        <div class="col-md-2 text-center">
                            <label>
                                <img src="<?=base_url() . 'images/RAP/block/box_B.png'?>" alt="" class="img img-responsive">
                        ...
                        <div class="col-md-2 text-center">
                            <label>
                                <img src="<?=base_url() . 'images/RAP/block/box_C.png'?>" alt="" class="img img-responsive">
                        ...
                        <div class="col-md-2 text-center">
                            <label>
                                <img src="<?=base_url() . 'images/RAP/block/box_D.png'?>" alt="" class="img img-responsive">
                        ...
                        <div class="col-md-2 text-center">
                            <label>
                                <img src="<?=base_url() . 'images/RAP/block/box_E.png'?>" alt="" class="img img-responsive">
