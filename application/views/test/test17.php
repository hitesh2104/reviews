...
@import url(https://fonts.googleapis.com/css?family=Open+Sans:400,300,600);
            ...
            <?php include_once 'include/test17_mira.php';?>
            <div class="content-wrapper">
            <section class="content-header">
            <!-- <h2>Matrices of Intellectual Reasoning (MIRA PT)</h2> -->
            </section>
            <section style="background: #ffffff" class="content">
            <center><h2>Matrices of Intellectual Reasoning (MIRA PT)</h2></center>
            <?php if ($sacId == "A") {?>
            <div class="intro1" style="display:block;">
            <h2><u>Introduction</u></h2>
            <br/>
            <p style="font-size:20px; text-align:justify;">
            <p>The Matrices of Intellectual Reasoning (MIRA PT) measures your ability to think conceptually and to solve problems. This test is divided into three sections:</p>
            ...
            <form method="post" id="questions_form" action="<?=base_url();?>test/processTest17">
