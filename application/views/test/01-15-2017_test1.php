                ...
                <ul class="questions_list" id="1">
                    ...
                    for ($i=1; $i <= count($sectionOneArr) ; $i++) {
                        ...
                        ?>
                            ...
                            <?php echo "Page ". ($i-1)/4 ." out of ".count($sectionOneArr)/4 ;?>
                            </div>
                            ...
                            <?php $j=0; }?>
                                    <tr class="info">
                                        <td width="70%"><?= $i.". ".$sectionOneArr[$i] ?></td>
                                        <td>
                                            <?php
                ...
                <ul class="questions_list" id="1">
                    ...
                    for ($i=1; $i <= count($sectionTwoArr) ; $i++) {
                        ...
                        ?>
                            ...
                            <div style="float: right;">
                                <?php echo "Page ". ($i-1)/4 ." out of ".count($sectionTwoArr)/4 ;?>
                            </div>
                        </li>
                            <li style="text-align: left" id="slide<?= ++$key; ?>" class="table-responsive">
                                <table width="100%" class="table">
