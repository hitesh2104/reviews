...
<?php include_once 'include/mira_comp.php';
?>
<div class="content-wrapper">
    ...
    <?php if ($sacId == "A") {?>
        ...
        <div id="slider" style="display:none">
            <form method="post" id="questions_form" action="<?=base_url();?>test/processTest14">
                    ...
                    <?php foreach ($sectionOneArr as $key => $secOneArr) {?>
                        <li style="text-align: center; id="slide<?=++$key;?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label>
                                    <img src="<?=base_url() . 'images/mira_sec_a/' . $option . '.jpg'?>" height="40"><br>
                    ...
                    <?php foreach ($sectionTwoArr as $key => $secOneArr) {?>
                        <li style="text-align: center; id="slide<?=++$key;?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                <label>
                                    <img src="<?=base_url() . 'images/mira_sec_b/' . $option . '.jpg'?>" height="80"><br>
                                    <input name="q<?=$key;?>" type="radio" value="<?=$ans;?>"/>
                                </label>
                                </div>
