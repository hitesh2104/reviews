	...
	foreach ($jspResult as $value) {	 ?>
        <tr>
          ...
          <td><ul  class="list-inline">
              ...
              <li><a href="javascript:void(0);" onclick="deleteRecord(<?php echo $value->jsp_id; ?>);"><i class="fa fa-remove"></i></a></li>
            </ul></td>
        </tr>
<?php
	}
...
?>
    <tr>
      <td colspan="7"><div class="alert alert-danger error-alert">No Job Success Profiles found.</div></td>
    </tr>
<?php } ?>
  </tbody>
</table>
