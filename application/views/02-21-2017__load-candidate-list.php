        ...
        if (!empty($candidateResult)) {
            ...
            foreach ($candidateResult as $value) {
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?= base_url() ?>candidate/candidate_details/<?= $value->candidate_id ?>"><?= $value->candidate_name; ?></a>
                    </td>
                    ...
                    <td>
                        <ul  class="list-inline">
                            ...
                            <li><a href="<?= base_url() . 'candidate/update/' . $value->candidate_id; ?>"><i class="fa fa-edit"></i></a></li>
