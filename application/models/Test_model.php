...
class Test_model extends CI_Model {
	...
	public function processTest3($post) {
		...
		if ($post['type'] == "secA") {
			...
			if (($percenatge > 0) && ($percenatge <= 4)) {
				$section = 1;
			} elseif (($percenatge >= 5) && ($percenatge <= 12)) {
				$section = 2;

			} elseif (($percenatge >= 13) && ($percenatge <= 25)) {
				$section = 3;

			} elseif ($percenatge >= 26 && $percenatge <= 30) {
				$section = 4;

			} elseif (($percenatge >= 31) && ($percenatge <= 40)) {
				$section = 5;

			} elseif (($percenatge >= 41) && ($percenatge <= 55)) {
				$section = 6;

			} elseif (($percenatge >= 56) && ($percenatge <= 75)) {
				$section = 7;

			} elseif (($percenatge >= 76) && ($percenatge <= 85)) {
				$section = 8;

			} elseif (($percenatge >= 86) && ($percenatge <= 90)) {
				$section = 9;

			} elseif (($percenatge >= 90) && ($percenatge <= 100)) {
				$section = 10;
			}
			...
			if (($percenatge > 0) && ($percenatge <= 3)) {
				$section = 1;

			} elseif (($percenatge >= 4) && ($percenatge <= 7)) {
				$section = 2;

			} elseif (($percenatge >= 8) && ($percenatge <= 10)) {
				$section = 3;

			} elseif (($percenatge >= 11) && ($percenatge <= 13)) {
				$section = 4;

			} elseif (($percenatge >= 14) && ($percenatge <= 20)) {
				$section = 5;

			} elseif (($percenatge >= 21) && ($percenatge <= 29)) {
				$section = 6;

			} elseif (($percenatge >= 30) && ($percenatge <= 40)) {
				$section = 7;

			} elseif (($percenatge >= 41) && ($percenatge <= 60)) {
				$section = 8;

			} elseif (($percenatge >= 61) && ($percenatge <= 80)) {
				$section = 9;

			} elseif (($percenatge >= 81) && ($percenatge <= 100)) {
				$section = 10;
			}

			$section_result = $section * 0.3;
		} elseif ($post['type'] == "secC") {
			$percenatge = number_format((($correct / 20) * 100), 0);
			$section = 0;
			...
			} elseif (($percenatge >= 15) && ($percenatge <= 21)) {
				$section = 3;

			} elseif ($percenatge >= 22 && $percenatge <= 28) {
				$section = 4;

			} elseif (($percenatge >= 29) && ($percenatge <= 31)) {
				$section = 5;

			} elseif (($percenatge >= 32) && ($percenatge <= 40)) {
				$section = 6;

			} elseif (($percenatge >= 41) && ($percenatge <= 60)) {
				$section = 7;

			} elseif (($percenatge >= 61) && ($percenatge <= 75)) {
				$section = 8;

			} elseif (($percenatge >= 76) && ($percenatge <= 88)) {
				$section = 9;

			} elseif (($percenatge >= 89) && ($percenatge <= 100)) {
				$section = 10;
			}
			...
			if (($percenatge > 0) && ($percenatge <= 12)) {
				$section = 1;

			} elseif (($percenatge >= 13) && ($percenatge <= 21)) {
				$section = 2;

			} elseif (($percenatge >= 22) && ($percenatge <= 34)) {
				$section = 3;

			} elseif ($percenatge >= 35 && $percenatge <= 42) {
				$section = 4;

			} elseif ($percenatge >= 43 && $percenatge <= 47) {
				$section = 5;

			} elseif (($percenatge >= 48) && ($percenatge <= 56)) {
				$section = 6;

			} elseif (($percenatge >= 57) && ($percenatge <= 69)) {
				$section = 7;

			} elseif (($percenatge >= 70) && ($percenatge <= 79)) {
				$section = 8;

			} elseif (($percenatge >= 80) && ($percenatge <= 89)) {
				$section = 9;
